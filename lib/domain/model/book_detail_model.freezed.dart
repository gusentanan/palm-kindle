...
mixin _$BookDetailModel {
  ...
  String? get imgJpeg => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      copyright: freezed == copyright
          ...
          : copyright // ignore: cast_nullable_to_non_nullable
              as bool?,
      imgJpeg: freezed == imgJpeg
          ? _value.imgJpeg
          : imgJpeg // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$BookDetailModelImpl implements _BookDetailModel {
  ...
  @override
  String toString() {
    return 'BookDetailModel(id: $id, title: $title, authors: $authors, birthYear: $birthYear, deathYear: $deathYear, subjects: $subjects, bookshelves: $bookshelves, languages: $languages, copyright: $copyright, imgJpeg: $imgJpeg, textPlain: $textPlain, downloadCount: $downloadCount)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.imgJpeg, imgJpeg) || other.imgJpeg == imgJpeg) &&
...
abstract class _BookDetailModel implements BookDetailModel {
  const factory _BookDetailModel(
      ...
      required final String? imgJpeg,
      required final String? textPlain,
      required final int? downloadCount}) = _$BookDetailModelImpl;
